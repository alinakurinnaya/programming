/*
 * Условие задачи:
 * Дан текст. Необходимо найти и вывести слово, которое встречается 
 * в этом тексте чаще всего.
 * 
 * Примечание:
 * Если таких слов несколько (они встречаются одинаковое максимальное 
 * количество раз), нужно вывести то, которое является меньшим 
 * в лексикографическом порядке (по алфавиту).
 */
