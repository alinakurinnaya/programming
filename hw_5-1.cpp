 ...
 * 1. Сгенерировать массив и заполнить его случайными числами.
 * 2. Используя многопоточность (например, разделение массива на части 
 *    и использование std::thread или std::async), найти 3 самых больших 
 *    элемента в этом массиве.
 * 3. Вычислить и вывести на экран сумму этих трех найденных элементов.
 */
